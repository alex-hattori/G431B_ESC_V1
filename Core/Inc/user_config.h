...
#define KT						__float_reg[12]									// Torque Constant (N-m/A)
#define R_TH					__float_reg[13]									// Thermal resistance (C/W)
#define C_TH					__float_reg[14]									// Thermal mass (C/J)
#define GR						__float_reg[15]									// Gear ratio
#define I_CAL					__float_reg[16]									// Calibration Current
#define P_MIN					__float_reg[17]									// Position setpoint lower limit (rad)
#define P_MAX					__float_reg[18]									// Position setupoint upper bound (rad)
#define V_MIN					__float_reg[19]									// Velocity setpoint lower bound (rad/s)
...
#define E_ZERO					__int_reg[4]
#define TERM_ON					__int_reg[5]
